...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        Log.d("mymy","request isMetric from "+context.getPackageName());
        // TODO (2) Return true if the user's preference for units is metric, false otherwise
        /** This will be implemented in a future lesson **/
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        String unitPrefValue = sp.getString(context.getString(R.string.pref_units_key)
                ,context.getString(R.string.pref_units_metric));
        return unitPrefValue.equals(context.getString(R.string.pref_units_metric));
