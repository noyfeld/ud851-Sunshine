...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler
    ...
    private final static int WEATHERLOADER_ID = 99;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(WEATHERLOADER_ID,null,this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            getSupportLoaderManager().restartLoader(WEATHERLOADER_ID,null,this);
            return true;
        ...
        if (id==WEATHERLOADER_ID){
            return new AsyncTaskLoader<String[]>(getApplicationContext()) {
                ...
                public String[] loadInBackground() {
                    ...
                    String zipRequestQuery = SunshinePreferences.getPreferredWeatherLocation(MainActivity.this);

                    URL weatherUrl = NetworkUtils.buildUrl(zipRequestQuery);

                    try {
                        String forecastInJsonString = NetworkUtils.getResponseFromHttpUrl(weatherUrl);
                        return OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,forecastInJsonString);
